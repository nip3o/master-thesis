...
An quick overview of the results are presented in \fref{tab:unit_times}
...
fair compared to later test runs, since large parts of the test suite
could not be run at this stage.\\
