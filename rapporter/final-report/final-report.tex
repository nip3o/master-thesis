...
% No page numbering of ToC pages
...
\chapter{Introduction}
  ...
  \input{introduction/audience.tex}
...
\chapter{Methodology}
  ...
  \input{methodology/development.tex}
...
\label{chap:theory}
  ...
  \section{Levels of testing}
    ...
    \input{theory/levels/acceptance-testing.tex}


  \section{Testing web applications}
    \input{theory/web.tex}
  ...
  \section{Evaluating test quality}
    \label{sec:quality}
    \input{theory/quality/quality.tex}
...
\label{chap:results}
  ...
  \input{results/choices/choices.tex}

  \section{Chosen levels of testing}
  \input{results/approaches.tex}
...
\label{chap:discussion}
  ...
  \input{discussion/tdd.tex}

  \section{Test efficiency}
  \input{discussion/efficiency.tex}

  \section{Test execution time}
  \input{discussion/time.tex}
